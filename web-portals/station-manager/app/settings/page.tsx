    ...
    <div className="p-8">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-[#1E1E1E] border border-[#2E2E2E] rounded-xl p-6">
          ...
          {/* Map embed */}
          {/* TODO: Replace placeholder src with real embed URL when branch location is stored */}
          ...
          {/* TODO: Wire to PATCH /api/v1/branch/settings when available */}
        ...
        <div className="bg-[#1E1E1E] border border-[#2E2E2E] rounded-xl p-6">
          ...
          {/* TODO: GET commission rate from backend config when available */}
